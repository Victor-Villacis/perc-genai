...
input_folder <- "/home/victor/working-percgenai/perc-genai/server/src/services/query_input/"
...
output_folder <- "/home/victor/working-percgenai/perc-genai/server/src/services/query_output" 
